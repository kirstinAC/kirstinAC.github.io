$(document).ready(function(){
	...
	*/
	...
	var slidedistanceOffset = 204; // If this value is 0 then the slide offset for each slide is exactly the width of the slide_wrapper
	var leftPadding = 254;
	var rightPadding = 10;
	
	var slidewidth = $("#rjcarousel_wrapper").width();
	var slidedistance = $("#rjcarousel_wrapper").width() - slidedistanceOffset - 100; // minus extra 100 pixel makes it easier to use
